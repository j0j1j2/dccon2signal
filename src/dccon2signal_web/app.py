...
def create_app(catalog: Catalog | None = None) -> FastAPI:
    ...
    async def home(q: str = "", page: int = 1) -> str:
        ...
        return _page(
            "StickerGen",
            f"""<header class=hero><h1 class=wordmark>STICKERGEN</h1>
...
def _page(title: str, body: str) -> str:
    ...
    *{{box-sizing:border-box}}html{{font-family:Inter,"Helvetica Neue",Arial,sans-serif}}
    ...
    .hero{{padding:5vh 0 32px;border-bottom:1px solid var(--line)}}
    ...
    @media(max-width:760px){{body{{padding:16px 14px 48px}}.hero{{padding:4vh 0 24px}}.hero h1.wordmark{{font-size:clamp(2.25rem,10vw,4rem);letter-spacing:.025em}}
